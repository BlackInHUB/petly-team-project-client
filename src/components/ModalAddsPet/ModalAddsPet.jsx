...
import { ModalAddsPetWrapper, ModalAddsPetForm, ModalAddsPetItputsWrapper, ModalAddsPetContainer,
    ModalAddsPetLabel, ModalAddsPetInput, ButtonWrapper, ModalAddsPetDescription, 
    InputContainer, LabelPhotoInput, ImageContainer, ImagePlus, Image,
    PhotoInput, TextareaWrapper, ModalAddsPetTextarea 
        ...
        <ModalAddsPetWrapper>   
            <ModalAddsPetForm encType="multipart/form-data">
                {step === 1 && (
                    ...
                    <ModalAddsPetLabel htmlFor="name">Name pet<span style={{ color: 'red' }}>*</span></ModalAddsPetLabel>
                        <ModalAddsPetInput
                            maxLength={16}
                            value={state.name} 
                    ...
                    <ModalAddsPetContainer>
                        <ModalAddsPetLabel htmlFor="birthday">Date of birth<span style={{ color: 'red' }}>*</span></ModalAddsPetLabel>
                        <DropdownGroup date={startDate} 
                    ...
                    <ModalAddsPetContainer>
                        <ModalAddsPetLabel htmlFor="breed">Breed <span style={{ color: 'red' }}>*</span></ModalAddsPetLabel>
                        <ModalAddsPetInput
                            maxLength={24}
                            value={state.breed} 
                            onChange={e => {
                ...
                {step === 2 && (
                    ...
                    <ModalAddsPetDescription>Add photo and some comments<span style={{ color: 'red' }}>*</span></ModalAddsPetDescription>
                    ...
                    <TextareaWrapper>
                        <ModalAddsPetLabel htmlFor="comments">Comments<span style={{ color: 'red' }}>*</span></ModalAddsPetLabel>
