...
//     EditPhotoInput } from './UserData.styled'
...
//             <ul>
//                 {/* <UserDataItem defaultValue={user.username} type="text" name='name' /> */}

//                 <UserDataItem defaultValue={userEmail} type="email" name='email' />

//                 <UserDataItem defaultValue={user.birthday || "01.01.1900"} type="text" name='birthday' />

//                 <UserDataItem defaultValue={user.phone} type="tel" name='phone' />

//                 <UserDataItem defaultValue={user.city} type="text" name='city' />
//             </ul>
